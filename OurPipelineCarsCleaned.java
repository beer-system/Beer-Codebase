...
public class OurPipelineCarsCleaned {
	Random rand = new Random(1991);
	String folder = "carsgoogleclean";//"carsStanCleaned";
	...
	*/
	...
	public void processBlocks() throws Exception{
		...
		for(int i=0;i<blockSize.size();i++){
			...
			System.out.println(Index2Str.get(blockId)+" "+block.size());
		}
		System.gc();
	...
	//	if(i1>0)
		...
		while(true){
			...
			if(processed_nodes.size()%100==0){
				...
				UpdateInferredEdges();
				 if(processed_nodes.size()>=200)
				{//00==0) {
					//if(pipelinetype.equals("pM3loop") ||pipelinetype.equals("ploop") )
						UpdateWeight();
						pipelinetype="pM3loop";
	...
	public static void main(String[] args) throws Exception{
		...
		OurPipelineCarsCleaned FF = new OurPipelineCarsCleaned();
