...
public class CleanClassifierBlockingproductsDL {
	...
	double g_to_r=0.0;
	double r_to_g=0.0;
	boolean useClassifier=true;//false;//true;//true;
	int mergedBlocks=-1;
...
*/
	...
	*/	/*gr=0;
	...
	public static void main(String[] args) throws Exception{
		...
		CleanClassifierBlockingproductsDL FF = new CleanClassifierBlockingproductsDL();
