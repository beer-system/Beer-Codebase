...
public class MultisourceWithoutClassifierEdgeOrder {
...
//			System.out.println(recordList1.get(p.x)+" "+s1);
	...
	public void processBlocks() throws Exception{
		...
		PrintStream newgt = new PrintStream("newgt.txt");
...
//		HashMap<String,Double> ruleBlockWeight = new HashMap<String,Double>();
		...
		while(true){
			...
			boolean end=false;
				...
				if (curr[0]>0.7 && Math.random()<0.7){
					output[1]=true;
					output[0]=true;

				}else if  (curr[0]>0.5 && Math.random()<0.7){
					output[1]=true;
					output[0]=true;
				}
				if(output[0])
...
*/		this.recallprint.println(processed_nodes.size()+" "+this.N);
	...
	public static void main(String[] args) throws Exception{
		...
		MultisourceWithoutClassifierEdgeOrder FF = new MultisourceWithoutClassifierEdgeOrder();
