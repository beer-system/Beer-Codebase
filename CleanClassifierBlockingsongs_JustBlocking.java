...
public class CleanClassifierBlockingsongs_JustBlocking {
	Random rand = new Random(1991);
	static Random generator = new Random(1992);

	String folder = "songs";//"citations";//"songs";
	...
	double g_to_r=0.0;
	double r_to_g=0.0;
	boolean useClassifier=true;//false;//true;
	int mergedBlocks=-1;
...
*/
	...
	public static void main(String[] args) throws Exception{
		CleanClassifierBlockingsongs_JustBlocking FF = new CleanClassifierBlockingsongs_JustBlocking();
