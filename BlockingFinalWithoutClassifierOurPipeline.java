...
public class BlockingFinalWithoutClassifierOurPipeline {
...
//		HashMap<String,Double> ruleBlockWeight = new HashMap<String,Double>();
	...
	public static void main(String[] args) throws Exception{
		...
		BlockingFinalWithoutClassifierOurPipeline FF = new BlockingFinalWithoutClassifierOurPipeline();
