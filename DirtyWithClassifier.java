...
public class DirtyWithClassifier {
...
//		HashMap<String,Double> ruleBlockWeight = new HashMap<String,Double>();
		...
		System.out.println(edge_prob.keySet().size()+"edgeprob");
	 	...
	 	boolean ooutput =  TrainClassifierPython( SimilarityList,0,10000000,true);//int num, boolean newsamples) throws Exception{
	...
	public static void main(String[] args) throws Exception{
		...
		DirtyWithClassifier FF = new DirtyWithClassifier();
