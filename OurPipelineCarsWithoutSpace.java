...
public class OurPipelineCarsWithoutSpace {
	Random rand = new Random(1991);
	String folder = "carsStanwithoutSpace";
	...
	int tau=0;
	int N=0;
	int numIgnore=500;//Number of blocks to ignore
	int queries=0;
	...
	*/
	...
	public static void main(String[] args) throws Exception{
		...
		OurPipelineCarsWithoutSpace FF = new OurPipelineCarsWithoutSpace();
